...
mean(linear_regression3$residuals)
```
Wystepuje heteroskedastycznosc, brak autokorelacji. 406 obserwacja odstająca. Rozkład wygląda na normalny chociaż jeden ogon zachowuje się dziwnie.
```{r}
